...
public class Main28Activity extends AppCompatActivity {
    ...
    RadioButton rdSusu, rdCoklat, rdKeju, rdStrawberry, rdBlueberry, rdNanas;EditText jumlah;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rdSusu=(RadioButton) findViewById(R.id.susu);
        rdCoklat=(RadioButton) findViewById(R.id.coklat);
        rdKeju=(RadioButton) findViewById(R.id.keju);
        rdStrawberry=(RadioButton) findViewById(R.id.strawberry);
        rdBlueberry=(RadioButton) findViewById(R.id.blueberry);
        rdNanas=(RadioButton) findViewById(R.id.nanas);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                else if(rdCoklat.isChecked()){
                    harga=2000;
                    jenis="Isi Coklat";
                }
                else if(rdKeju.isChecked()){
                    harga=2000;
                    jenis="Isi Keju";
                }
                else if(rdStrawberry.isChecked()){
                    harga=2000;
                    jenis="Isi Strawberry";
                }
                else if(rdBlueberry.isChecked()){
                    harga=2000;
                    jenis="Isi Blueberry";
                }
                else if(rdNanas.isChecked()){
                    harga=2000;
                    jenis="Isi Nanas";
                }
                ...
                Intent intent = new Intent(Main28Activity.this, Main8Activity.class);
                ...
                intent.putExtra("jumlah", jumlah.getText().toString()+" biji");
