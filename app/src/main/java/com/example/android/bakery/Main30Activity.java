...
public class Main30Activity extends AppCompatActivity {
    ...
    RadioButton rdMerah, rdHijau, rdKupas;
    EditText jumlah;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rdMerah=(RadioButton) findViewById(R.id.merah);
        rdHijau=(RadioButton) findViewById(R.id.hijau);
        rdKupas=(RadioButton) findViewById(R.id.kupas);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(rdMerah.isChecked()){
                    harga=1500;
                    jenis="Isi Kacang Merah";
                }
                else if(rdHijau.isChecked()){
                    harga=1500;
                    jenis="Isi Kacang Hijau";
                }

                else if(rdKupas.isChecked()){
                    harga=2000;
                    jenis="Isi Kacang Hijau Kupas";
                }

                total=harga*number;

                Intent intent = new Intent(Main30Activity.this, Main8Activity.class);
