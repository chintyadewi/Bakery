...
public class Main11Activity extends AppCompatActivity {
    ...
    RadioButton rdBundar, rdKotak, rdAnak, rdDewasa;
    EditText jumlah;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rdAnak=(RadioButton) findViewById(R.id.anak);
        rdDewasa=(RadioButton) findViewById(R.id.dewasa);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(rdBundar.isChecked() && rdAnak.isChecked()){
                    harga=90000+15000;
                    jenis="Bundar (Anak-Anak)";
                }
                else if(rdBundar.isChecked() && rdDewasa.isChecked()){
                    harga=90000+20000;
                    jenis="Bundar (Dewasa)";
                }
                else if(rdKotak.isChecked() && rdAnak.isChecked()){
                    harga=100000+15000;
                    jenis="Kotak (Anak-Anak)";
                }
                else if(rdKotak.isChecked() && rdDewasa.isChecked()){
                    harga=100000+20000;
                    jenis="Kotak (Dewasa)";
                }
