...
public class Main26Activity extends AppCompatActivity {
    ...
    RadioButton rdMeses, rdCoklat, rdPutih, rdKacang, rdKeju, rdGreentea;
    EditText jumlah;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rdMeses=(RadioButton) findViewById(R.id.meses);
        rdCoklat=(RadioButton) findViewById(R.id.coklat);
        rdPutih=(RadioButton) findViewById(R.id.putih);
        rdKacang=(RadioButton) findViewById(R.id.kacang);
        rdKeju=(RadioButton) findViewById(R.id.keju);
        rdGreentea=(RadioButton) findViewById(R.id.greentea);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                else if(rdPutih.isChecked()){
                    harga=2000;
                    jenis="Coklat Putih";
                }
                else if(rdKacang.isChecked()){
                    harga=2500;
                    jenis="Coklat Kacang";
                }
                ...
                Intent intent = new Intent(Main26Activity.this, Main8Activity.class);
