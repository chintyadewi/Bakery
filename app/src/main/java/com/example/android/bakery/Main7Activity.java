...
public class Main7Activity extends AppCompatActivity {
    ...
    RadioButton rdOriginal, rdOreo, rdStrawberry, rdGreentea;
    EditText jumlah;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rdOriginal=(RadioButton) findViewById(R.id.original);
        rdOreo=(RadioButton) findViewById(R.id.oreo);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(rdOriginal.isChecked()){
                    harga=5000;
                    jenis="Original (Whipped Cream)";
                }
                else if(rdOreo.isChecked()){
                    harga=6500;
                    jenis="Oreo";
                }
