...
public class Main9Activity extends AppCompatActivity {
    ...
    RadioButton rdBundar, rdKotak, rdStrawberry, rdBlueberry, rdMix;
    EditText jumlah;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rdBundar=(RadioButton) findViewById(R.id.cheese_bundar);
        rdKotak=(RadioButton) findViewById(R.id.cheese_kotak);
        rdStrawberry=(RadioButton) findViewById(R.id.strawberry);
        rdBlueberry=(RadioButton) findViewById(R.id.blueberry);
        rdMix=(RadioButton) findViewById(R.id.mix);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(rdBundar.isChecked() && rdStrawberry.isChecked()){
                    harga=200000+20000;
                    jenis="Bundar (Strawberry)";
                }
                else if(rdBundar.isChecked() && rdBlueberry.isChecked()){
                    harga=200000+30000;
                    jenis="Bundar (Blueberry)";
                }
                else if(rdBundar.isChecked() && rdMix.isChecked()){
                    harga=200000+40000;
                    jenis="Bundar (Mix Fruit)";
                }
                else if(rdKotak.isChecked() && rdStrawberry.isChecked()){
                    harga=220000+20000;
                    jenis="Kotak (Strawberry)";
                }
                else if(rdKotak.isChecked() && rdBlueberry.isChecked()){
                    harga=220000+30000;
                    jenis="Kotak (Blueberry)";
                }
                else if(rdKotak.isChecked() && rdMix.isChecked()){
                    harga=220000+40000;
                    jenis="Kotak (Mix Fruit)";
                }
                else if(rdBundar.isChecked()){
                    harga=200000;
                    jenis="Bundar (Original)";
                }
                else if(rdKotak.isChecked()){
                    harga=220000;
                    jenis="Kotak (Original)";
                }
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rdStrawberry.setChecked(false);
                rdBlueberry.setChecked(false);
                rdMix.setChecked(false);
