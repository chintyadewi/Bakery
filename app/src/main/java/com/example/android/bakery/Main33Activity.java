...
public class Main33Activity extends AppCompatActivity {
    ...
    RadioButton rdAbon, rdAyam, rdSapi;
    EditText jumlah;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rdAbon=(RadioButton) findViewById(R.id.abon);
        rdAyam=(RadioButton) findViewById(R.id.ayam);
        rdSapi=(RadioButton) findViewById(R.id.sapi);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                else if(rdAyam.isChecked()){
                    harga=2300;
                    jenis="Isi Ayam";
                }

                else if(rdSapi.isChecked()){
                    harga=2500;
                    jenis="Isi Daging Sapi";
                }

                total=harga*number;

                Intent intent = new Intent(Main33Activity.this, Main8Activity.class);
